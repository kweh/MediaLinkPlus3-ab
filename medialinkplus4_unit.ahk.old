...
SplashImageGUI(SplashImage, "Center", "Center", 2000, true)2
sleep, 1000
...
^RButton::
		...
		; menu, mlp, Icon, Tilldela och Bearbeta, %dir_icons%\24\tilldelabearbeta.png,,0
		...
		;Adn
		if (!InStr(mlNoteringar, "AUTOBOKAD"))
		{
